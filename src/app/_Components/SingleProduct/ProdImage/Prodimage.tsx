            ...
            <div className="mt-[7rem]">
                ...
                <div>
                    ...
                    <div className="w-full flex gap-9 justify-center mt-5">
                        ...
                        <button className="border-2 border-violet-800 hover:bg-violet-900 hover:text-white p-2 rounded-md dark:text-black transition ease-linear duration-300  ">Buy now</button>
                    </div>
                </div>
            </div>
        </>
