...
export const Cancelation:FC = () => {
  return (
    <div>
        ...
        <p className="text-xs">HARMAN DAVID believes in helping its customers as far as possible, and has therefore a liberal cancellation policy. Under this policy:</p>
        <ul className="list-disc list-inside mb-4  text-pretty text-justify text-xs flex flex-col gap-2">
            ...
            <li>HARMAN DAVID does not accept cancellation requests for perishable items like flowers, eatables etc. However, refund/replacement can be made if the customer establishes that the quality of product delivered is not good.</li>
            ...
            <li>In case of any Refunds approved by the HARMAN DAVID, it’ll take 3-5 days for the refund to be processed to the end customer.</li>
        </ul>
    </div>
  )
}